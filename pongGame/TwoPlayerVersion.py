...
while running:
    ...
    if game_Active:  
        ...
        if keys[pygame.K_UP]: paddle2_y -= paddle_speed
        if keys[pygame.K_DOWN]: paddle2_y += paddle_speed
    ...
    if not game_Active:
        winner = "Player 1 Wins!" if player1_score >= WINNING_SCORE else "Player 2 Wins!"
